...
public class DriverTokenAuthService implements AuthService<Authentication> {

    private static final AuthService INSTANCE = new DriverTokenAuthService();

    @AutoService(Provider.class)
    public static class DriverTokenAuthServiceProvider implements Provider {
