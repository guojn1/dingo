...
package io.dingodb.sqlline.auth.service;
...
public class SqlLineTokenService implements AuthService<Authentication> {

    private static final AuthService INSTANCE = new SqlLineTokenService();

    @AutoService(Provider.class)
    public static class SqlLineAuthServiceProvider implements Provider {
